<template>
    <div v-if="!edit">
        ...
        <div v-if="selectedTab == '2D'">
            <Depictor2D :molecule="modelValue"></Depictor2D>
        </div>
        <div
            v-if="selectedTab == '3D'"
            class="flex justify-center align-middle pt-5"
        >
            <Depictor3D :molecule="modelValue"></Depictor3D>
        </div>
    </div>
...
<script>
import Depictor2D from "@/App/Depictor2D.vue";
import Depictor3D from "@/App/Depictor3D.vue";
